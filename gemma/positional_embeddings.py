...
def apply_rope(
  ...
  # NTN: This is where the actual rotation happens. The input is split in half along the last dimension. Then, each half is rotated using the sine and cosine values calculated earlier. This rotation is what encodes the positional information into the embeddings.
